...
# Embedded KGSL patch data for standalone execution
EMBEDDED_PATCH = r"""From e5b86b7d3afc217f9970bd3b16b700b1f271f8a0 Mon Sep 17 00:00:00 2001
From: lfdevs <109842948+lfdevs@users.noreply.github.com>
Date: Tue, 6 Jan 2026 01:23:30 +0800
Subject: [PATCH] Add experimental KGSL support
...
---
 ...
 src/freedreno/drm/freedreno_device.c          |  34 +-
 ...
 .../frontends/dri/loader_dri3_helper.c        |  83 +----
 src/loader/loader.c                           |   6 +
 src/util/os_file.c                            |   4 +
 src/x11/x11_dri3.c                            |   5 +
 26 files changed, 898 insertions(+), 102 deletions(-)
...
index 502283fdd67..2cc9310f1fb 100644
--- a/meson.build
+++ b/meson.build
@@ -310,6 +310,10 @@ with_vdrm = [
   with_asahi_vk,
 ].contains(true)
...
index 4e277eb6f2a..652b576b9c6 100644
--- a/src/egl/drivers/dri2/egl_dri2.c
+++ b/src/egl/drivers/dri2/egl_dri2.c
@@ -799,6 +799,9 @@ dri2_setup_device(_EGLDisplay *disp, EGLBoolean software)
    _EGLDevice *dev;
    int render_fd;
...
index 11ff7a73037..99ad1873890 100644
...
index 8fbb9a60ed4..539bf40625a 100644
--- a/src/egl/drivers/dri2/platform_surfaceless.c
+++ b/src/egl/drivers/dri2/platform_surfaceless.c
@@ -394,6 +394,21 @@ dri2_initialize_surfaceless(_EGLDisplay *disp)
...
index e4b4b7140ac..be6969da116 100644
...
index 76f6e4cd2df..94bcf586a0e 100644
--- a/src/egl/main/eglapi.c
+++ b/src/egl/main/eglapi.c
@@ -684,6 +684,7 @@ eglInitialize(EGLDisplay dpy, EGLint *major, EGLint *minor)
...
index 6178140e7e7..169ccf052d5 100644
--- a/src/egl/main/egldisplay.h
+++ b/src/egl/main/egldisplay.h
@@ -198,6 +198,7 @@ struct _egl_display {
...
index 6c64e64171a..517bb48d631 100644
...
index ecb84aa57f8..ff4d336f80b 100644
...
+};
+
+uint32_t fd_get_features(struct fd_device *dev);void fd_device_disable_explicit_sync_heuristic(struct fd_device *dev);
 
 bool fd_has_syncobj(struct fd_device *dev);
 
@@ -202,6 +214,7 @@ int fd_pipe_wait(struct fd_pipe *pipe, const struct fd_fence *fence);
 /* timeout in nanosec */
...
index 53b72283d97..c2a008f489b 100644
--- a/src/freedreno/drm/freedreno_pipe.c
+++ b/src/freedreno/drm/freedreno_pipe.c
@@ -215,6 +215,12 @@ fd_pipe_emit_fence(struct fd_pipe *pipe, struct fd_ringbuffer *ring)
    return fence;
 }
...
index 3a243b6cd84..68ce2ee4169 100644
...
+   uint32_t features;
     ...
     *
@@ -296,6 +297,7 @@ struct fd_pipe_funcs {
...
index d2baf589e60..3383a0cb443 100644
--- a/src/freedreno/drm/meson.build
+++ b/src/freedreno/drm/meson.build
@@ -64,6 +64,17 @@ if freedreno_kmds.contains('virtio')
...
index 361d3b7c510..41cf36c24d9 100644
--- a/src/freedreno/vulkan/msm_kgsl.h
+++ b/src/freedreno/vulkan/msm_kgsl.h
@@ -544,6 +544,10 @@ struct kgsl_cmdbatch_profiling_buffer {
 /* ioctls */
...
index bd4a863bf72..77125b47e4e 100644
--- a/src/gallium/drivers/freedreno/freedreno_context.c
+++ b/src/gallium/drivers/freedreno/freedreno_context.c
@@ -501,6 +501,22 @@ fd_get_device_reset_status(struct pipe_context *pctx)
    return status;
 }
...
@@ -666,11 +682,6 @@ fd_context_init(struct fd_context *ctx, struct pipe_screen *pscreen,
...
@@ -685,13 +696,20 @@ fd_context_init(struct fd_context *ctx, struct pipe_screen *pscreen,
...
index 9d3b6c183f3..c27047316b0 100644
--- a/src/gallium/drivers/freedreno/freedreno_screen.c
+++ b/src/gallium/drivers/freedreno/freedreno_screen.c
@@ -633,7 +633,7 @@ fd_init_screen_caps(struct fd_screen *screen)
...
index ffa36a1d311..1a25608d014 100644
--- a/src/gallium/drivers/zink/zink_compiler.c
+++ b/src/gallium/drivers/zink/zink_compiler.c
@@ -4073,6 +4073,10 @@ zink_shader_compile(struct zink_screen *screen, bool can_shobj, struct zink_shad
...
index 34eee2ba113..f2b93d1d379 100644
--- a/src/gallium/drivers/zink/zink_screen.c
+++ b/src/gallium/drivers/zink/zink_screen.c
@@ -2355,6 +2355,10 @@ zink_screen_export_dmabuf_semaphore(struct zink_screen *screen, struct zink_reso
 {
...
+
    struct dma_buf_export_sync_file export = {
       ...
       .fd = -1,
@@ -2370,7 +2374,7 @@ zink_screen_export_dmabuf_semaphore(struct zink_screen *screen, struct zink_reso
    close(fd);
    if (ret) {
...
+
    const VkSemaphoreGetFdInfoKHR get_fd_info = {
       ...
       .semaphore = sem,
@@ -2422,7 +2430,8 @@ zink_screen_import_dmabuf_semaphore(struct zink_screen *screen, struct zink_reso
...
index a795d45ce29..a17cfc227f8 100644
...
-      }
       ...
       xcb_present_pixmap(draw->conn,
                          draw->drawable,
@@ -1389,27 +1362,13 @@ dri3_alloc_render_buffer(struct loader_dri3_drawable *draw, unsigned int fourcc,
...
@@ -1606,7 +1565,7 @@ dri3_alloc_render_buffer(struct loader_dri3_drawable *draw, unsigned int fourcc,
...
@@ -1617,21 +1576,13 @@ dri3_alloc_render_buffer(struct loader_dri3_drawable *draw, unsigned int fourcc,
                                                        depth, buffer->cpp * 8,
                                                        buffer_fds[0]);
    }
...
@@ -1653,9 +1604,6 @@ no_linear_buffer:
 no_image:
    free(buffer);
 no_buffer:
...
@@ -1920,11 +1868,8 @@ dri3_get_pixmap_buffer(struct dri_drawable *driDrawable, unsigned int fourcc,
...
-   int                                  fence_fd;
    ...
    if (buffer)
@@ -1936,15 +1881,6 @@ dri3_get_pixmap_buffer(struct dri_drawable *driDrawable, unsigned int fourcc,
    if (!buffer)
       goto no_buffer;
...
@@ -1954,14 +1890,6 @@ dri3_get_pixmap_buffer(struct dri_drawable *driDrawable, unsigned int fourcc,
...
@@ -1972,17 +1900,12 @@ dri3_get_pixmap_buffer(struct dri_drawable *driDrawable, unsigned int fourcc,
...
index 977e1fae4c1..9ccea3c8b07 100644
--- a/src/loader/loader.c
+++ b/src/loader/loader.c
@@ -711,6 +711,12 @@ loader_get_linux_pci_id_for_fd(int fd, int *vendor_id, int *chip_id)
 bool
...
index bb7135c62b0..4719ffb3dd0 100644
...
+
 ...
 {
diff --git a/src/x11/x11_dri3.c b/src/x11/x11_dri3.c
index 3587d24d6ad..b995372be66 100644
--- a/src/x11/x11_dri3.c
+++ b/src/x11/x11_dri3.c
@@ -23,6 +23,7 @@
...
+#include <string.h>
 ...
 #include <stdlib.h>
 #include <fcntl.h>
@@ -48,6 +49,10 @@ x11_dri3_open(xcb_connection_t *conn,
    int                          fd;
...
class FilePatch:
    def __init__(self, old_path, new_path):
        ...
        self.is_new = (old_path == '/dev/null' or 'dev/null' in old_path)
        self.hunks = []
        ...
        if line.startswith('diff --git'):
            ...
            while i < len(lines) and not lines[i].startswith('@@') and not lines[i].startswith('diff --git'):
                if lines[i].startswith('--- '):
                    old_p = lines[i][4:].strip()
                elif lines[i].startswith('+++ '):
                    new_p = lines[i][4:].strip()
                i += 1
            current_file = FilePatch(old_p, new_p)
...
def find_target_file(target_path, root_dir='.'):
    clean_path = re.sub(r'^[ab]/', '', target_path)
    
    # Strict rule: root meson.build must only be searched at root
    if clean_path == 'meson.build':
        root_meson = os.path.join(root_dir, 'meson.build')
        if os.path.exists(root_meson):
            return root_meson
        return None

    # Try exact relative path first
    exact_path = os.path.join(root_dir, clean_path)
    if os.path.exists(exact_path):
        return exact_path

    # Search subdirectories by matching file name and immediate parent folder
    target_name = os.path.basename(clean_path)
    target_parent = os.path.basename(os.path.dirname(clean_path))

    for root, _, files in os.walk(root_dir):
        if target_name in files:
            candidate = os.path.join(root, target_name)
            if target_parent:
                if os.path.basename(root) == target_parent:
                    return candidate
            else:
                return candidate
    return None

def find_match_index(file_lines, search_lines, start_idx=0):
    n = len(search_lines)
    if n == 0:
        return start_idx
        
    # Pass 1: Match ignoring trailing whitespace
    for i in range(start_idx, len(file_lines) - n + 1):
        if all(file_lines[i + j].rstrip() == search_lines[j].rstrip() for j in range(n)):
            return i
            
    # Pass 2: Fuzzy match ignoring both leading and trailing whitespace
    for i in range(start_idx, len(file_lines) - n + 1):
        if all(file_lines[i + j].strip() == search_lines[j].strip() for j in range(n)):
            return i
            
    return -1

def create_new_file(target_path, hunks, root_dir='.'):
    clean_path = re.sub(r'^[ab]/', '', target_path)
...
def apply_hunks(file_path, hunks):
    ...
    for hunk_idx, hunk in enumerate(hunks):
        search_lines = [l[1:] for l in hunk.lines if l.startswith((' ', '-'))]
        replace_lines = [l[1:] for l in hunk.lines if l.startswith((' ', '+'))]
        
        match_idx = find_match_index(file_lines, search_lines, start_idx)
        if match_idx == -1:
            # Fallback: search from top of file if offset shifted backwards
            match_idx = find_match_index(file_lines, search_lines, 0)
            
        if match_idx == -1:
            print(f"  [!] Failed to apply hunk #{hunk_idx + 1} (anchors not found)")
            continue
            
        # Perform slice replacement
        file_lines[match_idx : match_idx + len(search_lines)] = replace_lines
        start_idx = match_idx + len(replace_lines)
        print(f"  [+] Applied hunk #{hunk_idx + 1} around line {match_idx + 1}")
        
    with open(file_path, 'w', encoding='utf-8', newline='') as f:
        f.write(newline.join(file_lines) + newline)

def main():
    patch_text = EMBEDDED_PATCH
    if len(sys.argv) > 1 and os.path.exists(sys.argv[1]):
        print(f"Loading patch from {sys.argv[1]}...")
        with open(sys.argv[1], 'r', encoding='utf-8', errors='ignore') as f:
            patch_text = f.read()
    else:
        print("Using embedded patch data...")

    file_patches = parse_patch(patch_text)
    print(f"Parsed {len(file_patches)} file modifications.\n")

    for fp in file_patches:
        target_name = re.sub(r'^[ab]/', '', fp.new_path or fp.old_path)
        print(f"Processing: {target_name}")
        
        if fp.is_new:
            create_new_file(target_name, fp.hunks)
            continue
            
        target_file = find_target_file(target_name)
        if not target_file:
            print(f"  [-] Target file not found in directory tree. Skipping.")
            continue
            
        if target_file != target_name:
            print(f"  [*] Located at: {target_file}")
            
        apply_hunks(target_file, fp.hunks)
